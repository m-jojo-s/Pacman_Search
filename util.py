...
class PriorityQueue:
    ...
    def item_present_with_higher_pathCost(self, item, priority):
        # returns (index and count) of item in heap if item is in Queue with higher cost
        # Else returns None
    ...
    def Update_priority(self, item, priority, index, count):
        # update priority of a node already present in the heap given its index
        # and rebuild the heap. 
        del self.heap[index]
        self.heap.append((priority, count, item))
